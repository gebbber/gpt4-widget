        ...
        <Section title="Features" dismissable>
            ...
            <ul className="pl-6 flex flex-col gap-1 mt-1">
                <li className="list-disc pl-0">
                    <span className="font-bold">It's working with a plausible data model:</span> An
                    array of request times is provided using a React context. To adapt it for
                    production, a context provider could <code>fetch</code> a request count, and the
                    widget should function as-is.
                </li>
                <li className="list-disc pl-0">
